                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    ...
                                    <p style="{{ $style['paragraph'] }}">
                                        <b> You changed profile data.</b>
                                    </p>

                                    @if(isset($dataToSend['name']))
                                        New name: <b>{{$dataToSend['name']}}</b> <br>
                                    @endif
                                    @if(isset($dataToSend['surname']))
                                        New surname: <b>{{$dataToSend['surname']}}</b> <br>
                                    @endif
                                    @if(isset($dataToSend['email']))
                                        New email: <b>{{$dataToSend['email']}}</b><br>
                                    @endif
